...
legacy_rmse_name_list = ["sigflow","sigfit" , "mutationalPatterns strict", "mutationalPatterns", "deconstructSigs" ]
...
sbs_rmse_name_list = ["sigflow", "sigfit", "mutationalPatterns strict", "mutationalPatterns" , "deconstructSigs"]
...
legacy_df_list = [ mutationalPatterns_legacy_exposure_df.sort_values(by=["sample"]) , mutationalPatterns_strict_legacy_exposure_df.sort_values(by=["sample"]) ,sigfit_legacy_exposure_df.sort_values(by=["sample"]), sigflow_legacy_exposure_df.sort_values(by=["sample"]),  deconstructSigs_legacy_exposure_df.sort_values(by=["sample"]) ]
legacy_df_name_list = [ "mutationalPatterns_legacy", "mutationalPatterns_strict_legacy", "sigfit" , "sigflow" ,  "deconstruct_legacy"]
...
sbs_df_name_list = [ "mutationalPatters_sbs",  "sigfit_sbs" , "sigflow_sbs" ,  "deconstructSigs_sbs"]
fig = plt.figure(figsize=(120, 30))
fig.subplots_adjust(right = 0.9, wspace=.01)
rows = 6
columns = 6
