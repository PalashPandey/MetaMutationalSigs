...
class model_sigfit_fit
  : public stan::model::model_base_crtp<model_sigfit_fit> {
private:
        int family;
        int C;
        int S;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int g = 1; g <= G; ++g) {
                ...
                lp_accum__.add(dirichlet_log<propto__>(get_base1(exposures, g, "exposures", 1), get_base1(kappa, g, "kappa", 1)));
            }
