...
class model_sigfit_fitext
  : public stan::model::model_base_crtp<model_sigfit_fitext> {
private:
        int family;
        int C;
        int S;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("kappa", "G", G);
            context__.validate_dims("data initialization", "kappa", "vector_d", context__.to_vec(G,(S + N)));
            kappa = std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(G, Eigen::Matrix<double, Eigen::Dynamic, 1>((S + N)));
            vals_r__ = context__.vals_r("kappa");
            pos__ = 0;
            size_t kappa_j_1_max__ = (S + N);
            size_t kappa_k_0_max__ = G;
            for (size_t j_1__ = 0; j_1__ < kappa_j_1_max__; ++j_1__) {
                for (size_t k_0__ = 0; k_0__ < kappa_k_0_max__; ++k_0__) {
                    kappa[k_0__](j_1__) = vals_r__[pos__++];
                }
            }
            size_t kappa_i_0_max__ = G;
            for (size_t i_0__ = 0; i_0__ < kappa_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "kappa[i_0__]", kappa[i_0__], 0);
            }
            current_statement_begin__ = 84;
            validate_non_negative_index("alpha", "C", C);
            validate_non_negative_index("alpha", "N", N);
            context__.validate_dims("data initialization", "alpha", "vector_d", context__.to_vec(N,C));
            alpha = std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(N, Eigen::Matrix<double, Eigen::Dynamic, 1>(C));
        ...
        try {
            ...
            for (int g = 1; g <= G; ++g) {
                ...
                if (as_bool(logical_eq(dpp, 1))) {
                    ...
                    lp_accum__.add(dirichlet_log<propto__>(get_base1(exposures_all, g, "exposures_all", 1), get_base1(kappa, g, "kappa", 1)));
                }
            }
            current_statement_begin__ = 174;
            for (int n = 1; n <= N; ++n) {
                current_statement_begin__ = 176;
                lp_accum__.add(dirichlet_log<propto__>(get_base1(extra_sigs, n, "extra_sigs", 1), get_base1(alpha, n, "alpha", 1)));
            }
