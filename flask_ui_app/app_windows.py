...
def progress():
	def generate():
		...
		if glob.glob("./uploads/*.vcf"):
			...
			matGen.SigProfilerMatrixGeneratorFunc("MetaMutationalSigs",'GRCh37' , "C:/Users/pande/OneDriveDrexelUniversity/Documents/Fall-2021/Coop/CGC/SanjeeVCFFiles/PLOS_review_paper/metaSignatures/flask_ui_app/uploads")
			x = x + 33
			yield "data:" + str(x) + "\n\n"
			...
			shutil.make_archive("metaMutationalSignatures_results", 'zip', "C:/Users/pande/OneDriveDrexelUniversity/Documents/Fall-2021/Coop/CGC/SanjeeVCFFiles/PLOS_review_paper/metaSignatures/flask_ui_app/uploads")
			shutil.rmtree("C:/Users/pande/OneDriveDrexelUniversity/Documents/Fall-2021/Coop/CGC/SanjeeVCFFiles/PLOS_review_paper/metaSignatures/flask_ui_app/uploads")
