...
RUN Rscript -e "library("reticulate");use_python("python3");library("devtools");install_github("AlexandrovLab/SigProfilerMatrixGeneratorR");library("SigProfilerMatrixGeneratorR");install('GRCh37', rsync=FALSE, bash=TRUE)"
